...
\title{\chead{}
\rhead{Página \thepage}
\lfoot{Manual de usuario administrador}
\cfoot{}
...
{\large \bigskip{}
}{\Large Manual de usuario administrador}{\large }\\
{\large \bigskip{}
Julio 2008\bigskip{}
}}
...
necesidad de conocer los pormenores de su funcionamiento. Para esto
...
grupo, seleccionándolo y presionando el botón {}``Nuevo'' en la
...
de las asociación cliente-trabajo dados de alta en el sistema. Simplemente
seleccionando cada casilla se le estará dando acceso a todos los integrantes
del grupo a los respectivos trabajos.
...
Existe un grupo {}``virtual'' de usuarios a los cuales le serán
asignadas alertas del sistema, definidas alertas de interés general.
Estas alertas avisan a los usuarios del grupo de algún problema o
situación importante o crítica del sistema, por ejemplo si algún trabajo
de un usuario supero su cuota de espacio en disco.
...
son los trabajos que están siendo ejecutados actualmente en el sistema.
...
\includegraphics[scale=0.35]{31AConf}
...
lograr un máximo desempeño del cluster. Estas configuraciones avanzadas
...
Una cola puede ser detenida. Cuando una cola es detenida son detenidos
...
Los usuarios Administradores al igual que los demás usuarios reciben
alertas del sistemas las cuales podrán visualizar en el menú Alertas.
