...
insert into alertas (asunto,body) values ('Comienzo de ejecución de trabajo','El trabajo {TRABAJO} ha comenzado su ejecución');
insert into alertas (asunto,body) values ('Finalización de trabajo','El trabajo {TRABAJO} ha finalizado');
insert into alertas (asunto,body) values ('Error de ejecución de trabajo','El trabajo {TRABAJO} ha fallado');
