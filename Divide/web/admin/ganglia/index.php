...
<?php
	...
	$url = GANGLIA_URL;
	$url_carga = GANGLIA_URL."/graph.php?g=load_report&z=medium";
	$url_cpu = GANGLIA_URL."/graph.php?g=cpu_report&z=medium";
	$url_mem = GANGLIA_URL."/graph.php?g=mem_report&z=medium";
  	$url_network = GANGLIA_URL."/graph.php?g=network_report&z=medium";
